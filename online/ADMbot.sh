...
msg -ama " BOT DE TELEGRAM Mod By VPS-SN \033[1;31m"
msg -bar
...
local bot_retorno="$LINE\n"
         ...
         bot_retorno+="$(fun_trans "Bienvenido al BOT") Mod By @Sin_Nombre22\n"
         bot_retorno+="$LINE\n"
